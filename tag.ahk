...
::<tr>::{end}< /tr>{left 4}{backspace}{left 1}
::<th>::{end}< /th>{left 4}{backspace}{left 1}
::<td>::{end}< /td>{left 4}{backspace}{left 1}
::<div>::{end}< /div>{left 5}{backspace}{left 1}
...
::<dl>::< /dl>{end}{left 4}{backspace}{left 1}
::<dt>::< /dt>{end}{left 4}{backspace}{left 1}
::<dd>::< /dd>{end}{left 4}{backspace}{left 1}
...
::<ref>::< /ref>{left 5}{backspace}{left 1}
