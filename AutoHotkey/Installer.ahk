...
<div class="page" id="start">
	...
	<div id="license">AutoHotkey is open source software: <a href="javascript:AHK('ReadLicense')">read license</a></div>
  <div id="extract"><a href="javascript:AHK('Extract')" title="Save program files without installing.">extract to...</a></div>
</div>
...
<div class="page" id="custom-install">
	...
	<div class="nav" id="ci_nav">
		...
		<a id="ci_nav_install" href="javascript:AHK('CustomInstall')" onclick="beforeCustomInstall()">install</a>
	</div>
	<div class="pager" id="ci_pager">
		...
		<div class="page" id="ci_location">
			...
			<input type="text" class="textbox" id="installdir" value="C:\Program Files\AutoHotkey" tabindex="11"> <a href="javascript:AHK('SelectFolder', 'installdir', 'Select the folder to install AutoHotkey in.')" id="installdir_browse" class="button" tabindex="12">Browse</a></label><br>
		...
		<div class="page" id="ci_options">
			...
			<a href="javascript:AHK('CustomInstall')" onclick="beforeCustomInstall()" id="install_button" class="button">Install</a>
		</div>
	</div>
</div>
...
<div class="page" id="done">
	...
	<div class="options">
		<a href="javascript:AHK('ViewHelp', '/docs/AHKL_ChangeLog.htm')">View Changes &amp; New Features</a>
		<a href="javascript:AHK('ViewHelp', '/docs/Tutorial.htm')">View the Tutorial</a>
		<a href="javascript:AHK('RunAutoHotkey')">Run AutoHotkey</a>
		<a href="javascript:AHK('Quit')" id="done_exit">Exit</a>
	</div>
</div>
